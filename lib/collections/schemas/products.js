 ...
 * @property {Number} index optional, Variant position number in
 * list. Keep array index for moving variants in a list.
 ...
 * @property {Boolean} inventoryPolicy, default value: `false`, If disabled,
 * item can be sold even if it not in stock.
 * @property {Number} lowInventoryWarningThreshold, default value: `0`,
 * Warn of low inventory at this number
 * @property {Number} inventoryQuantity, default value: `0`
 * @property {Number} minOrderQuantity optional
 * @property {Boolean} isLowQuantity optional, true when at least 1 variant
 * is below `lowInventoryWarningThreshold`
 * @property {Boolean} isSoldOut optional, denormalized field, indicates when
 * all variants `inventoryQuantity` is 0
 ...
 * @property {String} optionTitle, Option internal name, default value:
 * `"Untitled option"`
 * @property {Metafield[]} metafields optional
 ...
 * @property {Boolean} isLowQuantity denormalized, true when at least 1 variant
 *  is below `lowInventoryWarningThreshold`
 * @property {Boolean} isSoldOut denormalized, Indicates when all variants
 * `inventoryQuantity` is zero
 * @property {Boolean} isBackorder denormalized, `true` if product not in stock,
 *  but customers anyway could order it
 * @property {Boolean} requiresShipping default value: `true`, Require a
 * shipping address
