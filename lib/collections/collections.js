 ...
 */
export const WalletHistories = new Mongo.Collection("WalletHistories");

WalletHistories.attachSchema(Schemas.WalletHistories);
 ...
 */
export const StaticPage = new Mongo.Collection("StaticPage");

StaticPage.attachSchema(Schemas.StaticPage);
